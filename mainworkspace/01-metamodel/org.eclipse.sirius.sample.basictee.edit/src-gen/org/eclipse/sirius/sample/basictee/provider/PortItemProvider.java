...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.sample.basictee.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Port_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Port_id_feature", "_UI_Port_type"),
						BasicteePackage.Literals.PORT__ID, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						BasicteePackage.Literals.PORT__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addConnectionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Port_connections_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Port_connections_feature",
								"_UI_Port_type"),
						BasicteePackage.Literals.PORT__CONNECTIONS, true, false, true, null, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case BasicteePackage.PORT__ID:
		case BasicteePackage.PORT__TYPE:
